      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3 md:grid-rows-2">
        ...
        <div className="feature-card md:row-span-2 min-h-[26rem] sm:min-h-[28rem] p-6 sm:p-7 flex flex-col">
          ...
          <div className="relative">
            <h3 className="font-serif-italic text-2xl sm:text-3xl md:text-4xl text-white leading-tight">
        ...
        {/* Card 02 */}
        <div className="feature-card-dark md:col-span-2 min-h-[22rem] p-6 sm:p-7 flex flex-col">
